"""Backup platform for the S3 Compatible Backup integration."""
    ...
    async def _upload_multipart(
        ...
        try:
            ...
            async for chunk in stream:
                ...
                # Upload parts of exactly MULTIPART_MIN_PART_SIZE_BYTES
                # Some S3-compatible providers (Cloudflare R2) require
                # all non-trailing parts to have the same size
